...
// NEW: Custom layout specifically for Liquidation (Product)
const liquidationProductColumns = [
    { key: 'derived_product', label: 'Product Name' },
...
const tableColumns = {
    ...
    liquidation_per_product: liquidationProductColumns,
